...
export const SearchNavbarItem: React.FunctionComponent<Props> = (props: Props) => {
    ...
    const { queryState, setQueryState, submitSearch, searchCaseSensitivity, setSearchCaseSensitivity } = useGlobalStore(
        selectFromGlobalState,
        shallow
    )
